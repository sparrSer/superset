...
class Matcher {
  ...
  createElement(children, props) {
    const element = this.factory ? /*#__PURE__*/React__default.default.createElement(this.factory, props, children) : this.replaceWith(children, props);

    if (process.env.NODE_ENV !== "production" && typeof element !== 'string' && ! /*#__PURE__*/React__default.default.isValidElement(element)) {
...
exports.match = match;
//# sourceMappingURL=bundle-707b635b.js.map
